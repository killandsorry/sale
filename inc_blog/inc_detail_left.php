<div class="blog_content">
   ...
   <div class="content">
      <div style="min-height:250px;width:50%;margin:0 15px 15px 0; text-align:center;float:left;background-color: #fff;"><?=ads_show(10)?></div>
      <?
      ...
      echo ($content)
      ?>
      <div style="padding:5px 0; text-align:center;"><?=ads_show(10)?></div>
   ...
   <h2 class="example_title">Ý kiến của bạn</h2>
   <div class="fb-comments" data-href="<?=$url?>" data-width="660" data-numposts="5"></div>
