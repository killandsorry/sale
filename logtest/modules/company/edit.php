...
$com_name	= clean_string(getValue('com_name', 'str', 'POST', ''));
$com_name_accent	= strtolower(removeAccent($com_name));
...
$mycompany->add('com_website', 'com_website', 0, 0, '', 0, '', 0, '');
...
$mycompany_des    = new generate_form();
$mycompany_des->add('cd_description', 'cd_description', 0, 0, '', 0, '', 0, '');
$mycompany_des->addTable('company_description');
...
if($action == 'execute'){
	...
	if($msgError == ''){
      ...
      $db_des  = new db_execute($mycompany_des->generate_update_SQL('cd_com_id', $rec_id));
      unset($db_des);
...
<?=$form->text('H Phone', 'com_home_phone', 'com_home_phone', $com_home_phone, '', 0, 150, '')?>
<?=$form->text('Phone', 'com_mobile_phone', 'com_mobile_phone', $com_mobile_phone, '', 0, 150, '')?>
<?=$form->text('Website', 'com_website', 'com_website', $com_website, '', 0, 150, '')?>
